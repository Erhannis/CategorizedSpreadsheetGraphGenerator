...
//            ((XSSFChart) chart).setTitleText("Some lines");
//        }
//
...
//            if (xssfChart.getCTChart().getAutoTitleDeleted() == null) {
//                xssfChart.getCTChart().addNewAutoTitleDeleted();
//            }
//            xssfChart.getCTChart().getAutoTitleDeleted().setVal(false);
//
//            // plot area background and border line
//            if (xssfChart.getCTChartSpace().getSpPr() == null) {
//                xssfChart.getCTChartSpace().addNewSpPr();
//            }
...
//            if (xssfChart.getCTChartSpace().getSpPr().getLn() == null) {
//                xssfChart.getCTChartSpace().getSpPr().addNewLn();
//            }
